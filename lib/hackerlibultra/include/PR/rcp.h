...
#define VI_CTRL_ANTIALIAS_MODE_0                                                                                       \
    0x00000 /* Bit [9:8] anti-alias mode: AA enabled, resampling enabled, always fetch extra lines */
#define VI_CTRL_ANTIALIAS_MODE_1                                                                                       \
    0x00100 /* Bit [9:8] anti-alias mode: AA enabled, resampling enabled, fetch extra lines as-needed                  \
             */
#define VI_CTRL_ANTIALIAS_MODE_2                                                                                       \
    0x00200 /* Bit [9:8] anti-alias mode: AA disabled, resampling enabled, operate as if everything is                 \
               covered */
#define VI_CTRL_ANTIALIAS_MODE_3                                                                                       \
    0x00300 /* Bit [9:8] anti-alias mode: AA disabled, resampling disabled, replicate pixels */
