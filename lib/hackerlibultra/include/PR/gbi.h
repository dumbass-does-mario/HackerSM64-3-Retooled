...
#define gdSPDefLights2(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2)                                       \
    {                                                                                                                    \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                                  \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } }, {{ {r2,g2,b2},0,{r2,g2,b2},0,{x2,y2,z2},0}} \
        }                                                                                                                \
    }
#define gdSPDefLights3(ar, ag, ab, r1, g1, b1, x1, y1, z1, r2, g2, b2, x2, y2, z2, r3, g3, b3, x3, y3, z3)                   \
    {                                                                                                                        \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                                      \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                                                 \
                { { { r2, g2, b2 }, 0, { r2, g2, b2 }, 0, { x2, y2, z2 }, 0 } }, {{ {r3,g3,b3},0,{r3,g3,b3},0,{x3,y3,z3},0}} \
        }                                                                                                                    \
    }
    ...
    {                                                                                                                        \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                                      \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                                                 \
                ...
                { { { r3, g3, b3 }, 0, { r3, g3, b3 }, 0, { x3, y3, z3 }, 0 } }, {{ {r4,g4,b4},0,{r4,g4,b4},0,{x4,y4,z4},0}} \
        }                                                                                                                    \
    }
    ...
    {                                                                                                                        \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                                      \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                                                 \
                ...
                { { { r4, g4, b4 }, 0, { r4, g4, b4 }, 0, { x4, y4, z4 }, 0 } }, {{ {r5,g5,b5},0,{r5,g5,b5},0,{x5,y5,z5},0}} \
        }                                                                                                                    \
    }
    ...
    {                                                                                                                        \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                                      \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                                                 \
                ...
                { { { r5, g5, b5 }, 0, { r5, g5, b5 }, 0, { x5, y5, z5 }, 0 } }, {{ {r6,g6,b6},0,{r6,g6,b6},0,{x6,y6,z6},0}} \
        }                                                                                                                    \
    }
    ...
    {                                                                                                                        \
        { { { ar, ag, ab }, 0, { ar, ag, ab }, 0 } }, {                                                                      \
            { { { r1, g1, b1 }, 0, { r1, g1, b1 }, 0, { x1, y1, z1 }, 0 } },                                                 \
                ...
                { { { r6, g6, b6 }, 0, { r6, g6, b6 }, 0, { x6, y6, z6 }, 0 } }, {{ {r7,g7,b7},0,{r7,g7,b7},0,{x7,y7,z7},0}} \
        }                                                                                                                    \
    }
...
#define gdSPDefLookAt(rightx, righty, rightz, upx, upy, upz)                                                                      \
    {                                                                                                                             \
        {                                                                                                                         \
            { { { 0, 0, 0 }, 0, { 0, 0, 0 }, 0, { rightx, righty, rightz }, 0 } }, { {{0,0x80,0},0,{0,0x80,0},0,{upx,upy,upz},0}} \
        }                                                                                                                         \
    }
...
#define gSPScisTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy)                                           \
    {                                                                                                                  \
        ...
        gImmp1(pkt, G_RDPHALF_1,                                                                                       \
               (_SHIFTL(((s)                                                                                           \
                         - (((s16)(xl) < 0) ? (((s16)(dsdx) < 0) ? (MAX((((s16)(xl) * (s16)(dsdx)) >> 7), 0))          \
                                                                 : (MIN((((s16)(xl) * (s16)(dsdx)) >> 7), 0)))         \
                                            : 0)),                                                                     \
                        16, 16)                                                                                        \
                | _SHIFTL(((t)                                                                                         \
                           - (((yl) < 0) ? (((s16)(dtdy) < 0) ? (MAX((((s16)(yl) * (s16)(dtdy)) >> 7), 0))             \
